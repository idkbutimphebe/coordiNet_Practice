...
<div class="flex justify-center mt-12">
 ...
 {{-- ⭐ Rating Form (Only show if event is completed) --}}
@php
    $isEventCompleted = $booking->status === 'completed' || 
                        (\Carbon\Carbon::parse($booking->event_date)->isPast());
@endphp
...
@else
    <div class="mt-10 p-4 rounded-xl bg-yellow-50 text-yellow-700 text-sm">
        ⭐ You can rate the coordinator once the event is completed.
    </div>
@endif
