...
<div class="p-6 space-y-6">
    ...
    <div class="bg-white rounded-xl shadow-sm p-5 no-print">
        <form method="GET" action="{{ route('coordinator.reports.bookings') }}" class="grid grid-cols-1 md:grid-cols-4 gap-4">
    ...
    <!-- ================= TABLE CARD ================= -->
    <div class="bg-white rounded-2xl shadow-sm overflow-hidden print:shadow-none print-area">

        <!-- Print Header (only visible when printing) -->
        <div class="print-header">
            <h2 class="text-2xl font-bold text-[#3E3F29] mb-2">Bookings Report</h2>
            ...
            <tbody class="divide-y divide-[#778873]/20">
                @forelse($bookings as $booking)
                    <tr class="hover:bg-[#A1BC98]/20 transition print:hover:bg-transparent">
                        ...
                        <td class="py-3 px-5 text-gray-700">{{ $booking->coordinator->coordinator_name ?? 'N/A' }}</td>
